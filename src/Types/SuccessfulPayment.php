...
class SuccessfulPayment implements \Teg\Types\Interface\InitObject
{
    ...
    public function __construct($request)
    {
        ...
        $this->invoice_payload = $request->invoice_payload ?? null;
        $this->shipping_option_id = $request->shipping_option_id ?? null;
        $this->order_info = new OrderInfo($request->order_info) ?? null;
        $this->telegram_payment_charge_id = $request->telegram_payment_charge_id ?? null;
        $this->provider_payment_charge_id = $request->provider_payment_charge_id ?? null;
    }

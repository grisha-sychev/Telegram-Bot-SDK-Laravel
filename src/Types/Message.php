...
class Message implements InitObject
{
    ...
    public function __construct($request)
    {
        ...
        $this->message_id = isset($request->message_id) ? $request->message_id : 0;
        $this->message_thread_id = isset($request->message_thread_id) ? $request->message_thread_id : 0;
        ...
        $this->sender_boost_count = isset($request->sender_boost_count) ? $request->sender_boost_count : null;
        ...
        $this->business_connection_id = isset($request->business_connection_id) ? $request->business_connection_id : null;
        ...
        $this->is_topic_message = isset($request->is_topic_message) ? $request->is_topic_message : null;
        $this->is_automatic_forward = isset($request->is_automatic_forward) ? $request->is_automatic_forward : null;
        ...
        $this->edit_date = isset($request->edit_date) ? $request->edit_date : null;
        $this->has_protected_content = isset($request->has_protected_content) ? $request->has_protected_content : null;
        $this->is_from_offline = isset($request->is_from_offline) ? $request->is_from_offline : null;
        $this->media_group_id = isset($request->media_group_id) ? $request->media_group_id : null;
        ...
        $this->effect_id = isset($request->effect_id) ? $request->effect_id : 0;
        ...
        $this->caption = isset($request->caption) ? $request->caption : null;
        ...
        $this->show_caption_above_media = isset($request->show_caption_above_media) ? $request->show_caption_above_media : null;
        ...
        $this->new_chat_title = isset($request->new_chat_title) ? $request->new_chat_title : null;
        $this->new_chat_photo = isset($request->new_chat_photo) ? array_map(fn($photo) => new PhotoSize($photo), $request->new_chat_photo) : null;
        $this->delete_chat_photo = isset($request->delete_chat_photo) ? $request->delete_chat_photo : null;
        $this->group_chat_created = isset($request->group_chat_created) ? $request->group_chat_created : null;
        $this->supergroup_chat_created = isset($request->supergroup_chat_created) ? $request->supergroup_chat_created : null;
        $this->channel_chat_created = isset($request->channel_chat_created) ? $request->channel_chat_created : null;
        ...
        $this->migrate_to_chat_id = isset($request->migrate_to_chat_id) ? $request->migrate_to_chat_id : null;
        $this->migrate_from_chat_id = isset($request->migrate_from_chat_id) ? $request->migrate_from_chat_id : null;
        ...
        $this->connected_website = isset($request->connected_website) ? $request->connected_website : null;

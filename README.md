# 🤖 TegBot - Мощный Laravel пакет для Telegram ботов

Создавайте профессиональных Telegram ботов в Laravel за минуты! TegBot - это пакет с мультиботной архитектурой, безопасностью и всеми возможностями Telegram Bot API.
